...
const AddDepartmentForm = (props) => {
    ...
    uploadTask.on(
      ...
      () => {
        ...
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
          setDoc(doc(db, "departments", `${timeNow.getTime()}`), {
            id: timeNow.getTime(),
            ...
            .then((res) => {
              setOpen(false);
              setIsLoading(false);
              enqueueSnackbar(`New department added successfully`, {
                variant: "success",
              });
            })
            .catch((error) => {
  ...
  return (
    <div>
      ...
      <ValidatorForm onSubmit={createDepartment}>
        <TextValidator
          id="title"
          ...
          fullWidth
          validators={["required"]}
          errorMessages={["Name of department is required"]}
        />
        <br />
